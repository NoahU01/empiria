  ...
  page(
    ...
    mdl("Hier bin ich richtig.", "Was eine Landingpage von einer Homepage unterscheidet.",
        ...
        steps=[("01", "Ein Fokus", "Eine Zielgruppe, ein Problem, eine Lösung – keine Ablenkung durch andere Themen."),
               ...
               ("03", "Ein klares Ziel", "Nie alles erklären – der Fokus liegt auf dem nächsten Schritt: Kontaktdaten oder Download mit echtem Mehrwert.")]),
    sec("Das Versprechen", "Tempo ohne Kompromisse.", style="margin-top:6mm"),
    ...
    stage("Unsere Impulsvorträge", 'Vier Themen. Eine Wirkung.',
          ...
          inhalt=cards([
            (None, "Warum sich niemand für Dein Produkt interessiert.",
             ...
             '<div class="fuss">Für Vertriebstagungen und Produktbereiche, die ihre Zielgruppe neu erreichen wollen.</div>'),
            (None, "Strategie, die endlich ankommt.",
             "Wie Strategie aus der Präsentation raus- und im Alltag des Teams ankommt.",
             '<div class="fuss">Für Führungskräfte-Events und Kickoffs, bei denen eine Strategie getragen werden muss.</div>'),
            (None, "Gründe Deinen stärksten Konkurrenten!",
             "Der Perspektivwechsel, der blinde Flecken sichtbar macht – bevor es die Konkurrenz tut.",
             '<div class="fuss">Für Strategietage und Führungsrunden, die aus eingefahrenen Mustern herauswollen.</div>'),
            (None, "Strategie für Aufsichtsräte",
             "Impulsvortrag und Halbtagesschulung: wie der Aufsichtsrat eine Strategie einordnet – auf Wunsch mit Zertifikat.",
             '<div class="fuss">Für Aufsichtsräte und Gremien, die Strategien fundiert beurteilen müssen.</div>'),
          ], 2, numbered=True, style="margin-top:6mm")
    ...
    stage("Unsere Workshops", "Drei Formate. Ein Ziel: Ergebnisse.",
          ...
          inhalt=cards([
            ...
            (None, "Moderation Deines Workshops",
             ...
             '<div class="fuss">Umfang nach Anlass</div>'),
